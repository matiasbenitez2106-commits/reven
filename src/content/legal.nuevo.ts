  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Supresión (artículo 16): pedir que eliminemos tus datos cuando su tratamiento ya no corresponda o cuando revoques tu consentimiento. Plazo máximo: 5 días hábiles. No procede cuando pueda perjudicar derechos de terceros o cuando exista una obligación legal de conservar los datos. Para dejar de operar en trato y que tus datos sean eliminados, tenés dos caminos distintos: (a) dar de baja tu cuenta desde la app, que abre un período de pausa de 90 días durante el cual podés reactivarla, y al final del cual el borrado se hace de forma automática (ver la sección “Baja de cuenta: qué pasa con tus datos”); o (b) ejercer este derecho de supresión del artículo 16 escribiendo a privacidad@apptrato.com, que se tramita dentro del plazo de 5 días hábiles ya indicado. Usar la baja desde la app no limita ni reemplaza tu derecho legal a pedir la supresión inmediata por los canales de contacto: podés elegir cualquiera de los dos caminos.",
    ...
    },
    {
      ...
      bullets: [
        "Datos de cuenta: se conservan mientras tu cuenta esté activa. Pedir la baja no elimina los datos de inmediato: tu cuenta entra en un período de pausa de 90 días corridos durante el cual los datos siguen existiendo en nuestros sistemas. Si no reactivás la cuenta antes de que se cumpla ese plazo, los datos se eliminan de forma definitiva e irreversible al completarse los 90 días, salvo lo que debamos conservar por obligación legal. Para el detalle completo de este proceso, consultá la sección “Baja de cuenta: qué pasa con tus datos”.",
        "Imágenes de DNI y selfie: se conservan, encriptadas y con acceso restringido a administradores, mientras tu cuenta esté activa y durante el período de baja de 90 días corridos descripto en la sección “Baja de cuenta: qué pasa con tus datos”. Si la cuenta no se reactiva, las imágenes se eliminan —incluida su baja en Cloudinary— al cumplirse ese plazo. Se conservan más allá de ese plazo únicamente si hay una denuncia, disputa o investigación en curso en tu contra, o si existe una obligación legal que nos exija retenerlas. Finalidad: prevenir fraudes y poder responder a requerimientos de la justicia o de autoridades competentes (por ejemplo, ante la denuncia de un delito). No se publican ni se entregan a otras personas usuarias.",
        "Scores de reconocimiento facial (match y liveness): se conservan como prueba de la decisión de verificación, siguiendo el mismo ciclo que el resto de tus datos de cuenta: mientras tu cuenta esté activa y durante el período de baja de 90 días, y se eliminan al completarse el borrado.",
        ...
        "Al darte de baja, el borrado efectivo de las imágenes (incluida su baja en Cloudinary) y de los datos sensibles asociados ocurre al completarse el período de pausa de 90 días, no de inmediato. Para el detalle de ese proceso, consultá la sección “Baja de cuenta: qué pasa con tus datos”. Al ejercer el derecho de supresión por los canales de contacto (privacidad@apptrato.com), se procede conforme a ese derecho según los plazos previstos por la ley. En ambos casos, el borrado efectivo no procede si existe una denuncia o investigación en curso, o una obligación legal que nos exija conservar los datos por un plazo determinado.",
      ],
    },
    {
...
export const TERMS_NUEVO: LegalDocContent = {

    ...
    <div className="mx-auto flex max-w-md flex-col px-4 py-16">
      <div className="card flex flex-col items-center gap-3 p-8 text-center">
        {ok ? (
          <>
            ...
            <p className="text-sm text-gray-500">
              Tu email quedó confirmado. Ya podés usar Reven con normalidad.
            </p>
          </>
        ) : (
          <>
        ...
        <div className="mt-2 flex gap-3">
          ...
          <Link href="/ingresar" className="rounded-lg border border-gray-300 px-4 py-2 text-sm font-medium hover:bg-gray-50">
            Ingresar
          </Link>
        </div>
      </div>

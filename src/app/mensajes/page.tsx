  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-8">
      ...
      {convos.length === 0 ? (
        ...
        <div className="divide-y divide-gray-100 dark:divide-stone-800 overflow-hidden rounded-xl border border-line dark:border-stone-800 bg-surface dark:bg-stone-900">
          {convos.map((c) => {

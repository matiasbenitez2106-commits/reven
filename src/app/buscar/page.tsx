                ...
                <div className="mt-8 flex items-center justify-center gap-2">
                  {result.page > 1 && (
                    <Link
                      ...
                      className="inline-flex items-center gap-1 rounded-lg border border-gray-300 dark:border-stone-700 bg-surface dark:bg-stone-900 px-3 py-2 text-sm hover:bg-gray-50 dark:hover:bg-stone-800"
                    >

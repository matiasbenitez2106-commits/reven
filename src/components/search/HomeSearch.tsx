  ...
  return (
    <form onSubmit={onSubmit} className="relative mx-auto mt-6 max-w-xl">
      ...
      <input
        ...
        className="h-14 w-full rounded-full border border-line dark:border-stone-700 bg-surface dark:bg-stone-900 pl-12 pr-28 text-base shadow-sm outline-none focus:border-brand-500 focus:ring-2 focus:ring-brand-100"
      />
      <button
        type="submit"

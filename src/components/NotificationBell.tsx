...
export function NotificationBell() {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute right-0 mt-2 w-80 max-w-[90vw] overflow-hidden rounded-xl border border-line dark:border-stone-800 bg-surface dark:bg-stone-900 shadow-lg">
          <div className="border-b border-line dark:border-stone-800 px-4 py-2 text-sm font-semibold">
            Notificaciones
          </div>

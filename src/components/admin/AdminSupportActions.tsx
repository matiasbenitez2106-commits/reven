...
export function AdminSupportActions({ id, closed }: { id: string; closed: boolean }) {
  ...
  return (
    <button
      onClick={toggle}
      disabled={loading}
      className="inline-flex items-center gap-1 rounded-lg border border-line dark:border-stone-800 px-2.5 py-1 text-xs font-medium text-gray-600 dark:text-stone-300 transition hover:bg-gray-50 dark:hover:bg-stone-800 disabled:opacity-50"
    >

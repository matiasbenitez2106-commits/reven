  ...
  return (
    <div className="flex flex-wrap gap-2">
      <button
        ...
        className={`${btn} border-gray-300 dark:border-stone-700 bg-surface dark:bg-stone-900 text-gray-700 dark:text-stone-200 hover:bg-gray-50 dark:hover:bg-stone-800`}
      >

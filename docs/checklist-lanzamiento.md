...
- [ ] Completar la **razón social** y el **domicilio legal** del responsable en los textos legales (van en `legal.nuevo.ts`, la versión que se publica).
- [ ] Reemplazar los **correos provisorios** (`privacidad@apptrato.com` / `soporte@apptrato.com`) por los definitivos.
